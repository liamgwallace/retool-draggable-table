...
const useTableState = () => {
  ...
  const [bioFormat] = Retool.useStateEnumeration({ name: 'bioFormat', enumDefinition: ['markdown', 'string'], initialValue: 'markdown', inspector: 'select', label: 'Bio Format', description: 'Display mode for the Bio column.' });
  const [columnOrder1] = Retool.useStateEnumeration({ name: 'columnOrder1', enumDefinition: ['user', 'role', 'enabled', 'createdAt', 'teams', 'website', 'bio', 'none'], initialValue: 'user', inspector: 'select', label: 'Column 1', description: 'First visible column.' });
  const [columnOrder2] = Retool.useStateEnumeration({ name: 'columnOrder2', enumDefinition: ['user', 'role', 'enabled', 'createdAt', 'teams', 'website', 'bio', 'none'], initialValue: 'role', inspector: 'select', label: 'Column 2', description: 'Second visible column.' });
  const [columnOrder3] = Retool.useStateEnumeration({ name: 'columnOrder3', enumDefinition: ['user', 'role', 'enabled', 'createdAt', 'teams', 'website', 'bio', 'none'], initialValue: 'enabled', inspector: 'select', label: 'Column 3', description: 'Third visible column.' });
  const [columnOrder4] = Retool.useStateEnumeration({ name: 'columnOrder4', enumDefinition: ['user', 'role', 'enabled', 'createdAt', 'teams', 'website', 'bio', 'none'], initialValue: 'createdAt', inspector: 'select', label: 'Column 4', description: 'Fourth visible column.' });
  const [columnOrder5] = Retool.useStateEnumeration({ name: 'columnOrder5', enumDefinition: ['user', 'role', 'enabled', 'createdAt', 'teams', 'website', 'bio', 'none'], initialValue: 'teams', inspector: 'select', label: 'Column 5', description: 'Fifth visible column.' });
  const [columnOrder6] = Retool.useStateEnumeration({ name: 'columnOrder6', enumDefinition: ['user', 'role', 'enabled', 'createdAt', 'teams', 'website', 'bio', 'none'], initialValue: 'website', inspector: 'select', label: 'Column 6', description: 'Sixth visible column.' });
  const [columnOrder7] = Retool.useStateEnumeration({ name: 'columnOrder7', enumDefinition: ['user', 'role', 'enabled', 'createdAt', 'teams', 'website', 'bio', 'none'], initialValue: 'bio', inspector: 'select', label: 'Column 7', description: 'Seventh visible column.' });
  ...
  const [theme] = Retool.useStateObject({ name: 'theme', initialValue: {}, inspector: 'text', label: 'Theme', description: 'Optional Retool theme token object. Usually leave this bound to the built-in theme data.' });
...
const useTableState = () => {
  ...
  const [indexColumn] = Retool.useStateEnumeration({ name: 'indexColumn', enumDefinition: ['none', 'order', 'sortOrder'], initialValue: 'none', inspector: 'select', label: 'Index Column', description: 'Optional order field to write back row position. Choose `none` if you do not want a persisted order field.' });
  const [columnsJson] = Retool.useStateArray({ name: 'columnsJson', initialValue: DEFAULT_SAMPLE_COLUMNS, inspector: 'text', label: 'Columns JSON', description: 'Array of column definitions. Supports `width`, `editable`, and optional `resizable`.' });
  const [columnOrderingJson] = Retool.useStateArray({ name: 'columnOrderingJson', initialValue: ['email', 'role', 'enabled', 'createdAt', 'teams', 'website', 'bio'], inspector: 'text', label: 'Column Ordering JSON', description: 'Array of `sourceKey` values in the order they should display.' });
